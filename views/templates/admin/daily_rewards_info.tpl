<div class="bootstrap">
    <div class="alert alert-info">
        <p>
            <strong>{l s='What are Daily Rewards?' d='Modules.Gamifications.Admin'}</strong>
        </p>
        <p>
        ...
        <p>
            {l s='Customers can convert points into free shipping or discounts which encourages them to place orders and visit your shop more often!' d='Modules.Gamifications.Admin'}
        </p>
    </div>
</div>