...
<div class="bootstrap">
    ...
    <div class="alert alert-warning">
        <p>
            <strong>{l s='Important' d='Modules.Gamifications.Admin'}</strong>
        </p>
        <p>
            {l s='Never delete a reward unless you are sure that reward is not assigned to any activity!' d='Modules.Gamifications.Admin'}
        </p>
        <p>
            {l s='Deleteing reward that is assigned to activity(s) may lead to unexpected behavour and customer dissatisfaction.' d='Modules.Gamifications.Admin'}
        </p>
    </div>
</div>